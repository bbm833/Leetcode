...
public:
  long long divide(int dividend, int divisor) {
    ...
    long long dividend_2 = abs(static_cast<long long>(dividend));
    long long divisor_2 = abs(static_cast<long long>(divisor));

    if (dividend_2 < divisor_2)
      return 0;
